...
if %errorlevel% equ 0 (
  cmd /k "cobc.exe --version && echo. && echo GnuCOBOL 3.2.0 (Jul 28 2023 22:58:42), (MinGW) "9.2.0" && echo GMP 6.2.1, cJSON 1.7.14, PDCursesMod 4.3.7, VB-ISAM "
  goto :eof
)
...
echo.
cobc.exe --version
echo. && echo GnuCOBOL 3.2.0 (Jul 28 2023 22:58:42), (MinGW) "9.2.0" && echo GMP 6.2.1, cJSON 1.7.14, PDCursesMod 4.3.7, VB-ISAM 
