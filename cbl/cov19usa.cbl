      ...
      *---------------------------------------------------------------*
           05  HEADING-LINE-1.
               ...
               10  FILLER             PIC X(07) VALUE 'STATE: '.
               10  HL1-STATE          PIC X(20).
               10  FILLER             PIC X(03) VALUE SPACE.
               10  HL1-PAGE-COUNT-AREA.
                   15  FILLER         PIC X(08) VALUE SPACE.
      ...
      *---------------------------------------------------------------*
       3000-CLOSE-FILES.
      *---------------------------------------------------------------*
      D     PERFORM 3100-PRINT-STATE-TABLE
      D         VARYING STATE-INDEX FROM 1 BY 1
      D         UNTIL STATE-INDEX > 57.
      ...
      *---------------------------------------------------------------*
           DISPLAY STATE-TABLE(STATE-INDEX).
      *---------------------------------------------------------------*
      ...
      *        DISPLAY 'HEADING LINE SEARCH'
                MOVE 'STATE NOT FOUND' TO HL1-STATE
           WHEN STATE-CODE(NAME-INDEX) = REPORT-STATE-SW
                MOVE STATE-NAME(NAME-INDEX) TO HL1-STATE.
      *---------------------------------------------------------------*
