...
class ZosmfSession {
    ...
    static createBasicZosmfSessionFromArguments(args) {
        ...
        sessionConfig.type = imperative_1.SessConstants.AUTH_TYPE_BASIC;
        ...
        if (sessionConfig.user && sessionConfig.password) {
            ...
            sessionConfig.type = imperative_1.SessConstants.AUTH_TYPE_TOKEN;
            sessionConfig.tokenType = args.tokenType;
            sessionConfig.tokenValue = args.tokenValue;
        }
        return new imperative_1.Session(sessionConfig);
    }
    static get log() {
...
ZosmfSession.ZOSMF_OPTION_HOST_PROFILE = Object.assign(Object.assign({}, ZosmfSession.ZOSMF_OPTION_HOST), { required: false });
/**
...
ZosmfSession.ZOSMF_OPTION_USER_PROFILE = Object.assign(Object.assign({}, ZosmfSession.ZOSMF_OPTION_USER), { required: false });
/**
...
ZosmfSession.ZOSMF_OPTION_PASSWORD_PROFILE = Object.assign(Object.assign({}, ZosmfSession.ZOSMF_OPTION_PASSWORD), { required: false });
/**
