...
class PingTso {
    ...
    static ping(session, servletKey) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const res = yield core_for_zowe_sdk_1.ZosmfRestClient.putExpectJSON(session, PingTso.getResource(servletKey), [core_for_zowe_sdk_1.ZosmfHeaders.X_CSRF_ZOSMF_HEADER, imperative_1.Headers.APPLICATION_JSON], null);
