...
class StartTso {
    ...
    static startCommon(session, commandParms) {
        ...
        return core_for_zowe_sdk_1.ZosmfRestClient.postExpectJSON(session, startResources, [core_for_zowe_sdk_1.ZosmfHeaders.X_CSRF_ZOSMF_HEADER, imperative_1.Headers.APPLICATION_JSON]);
    }
    /**
     * Start TSO address space with provided parameters.
     * @static
