...
class SendTso {
    ...
    static sendDataToTSOCommon(session, commandParams) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return core_for_zowe_sdk_1.ZosmfRestClient.putExpectJSON(session, TsoConstants_1.TsoConstants.RESOURCE + parameters, [core_for_zowe_sdk_1.ZosmfHeaders.X_CSRF_ZOSMF_HEADER, imperative_1.Headers.APPLICATION_JSON], jobObj);
        });
    }
    /**
    ...
    static getDataFromTSO(session, servletKey) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return core_for_zowe_sdk_1.ZosmfRestClient.getExpectJSON(session, TsoConstants_1.TsoConstants.RESOURCE + parameters, [core_for_zowe_sdk_1.ZosmfHeaders.X_CSRF_ZOSMF_HEADER, imperative_1.Headers.APPLICATION_JSON]);
        });
    }
    /**
