...
exports.noTsoStartInput = {
    message: imperative_1.apiErrorHeader + `No tso start address space parameters were supplied.`
};
/**
 * No input parameters were provided error message
 * @static
...
exports.noTsoIssueInput = {
    message: imperative_1.apiErrorHeader + `No tso issue command parameters were supplied.`
};
/**
...
exports.noTsoStopInput = {
    message: imperative_1.apiErrorHeader + `No tso stop address space parameters were supplied.`
};
/**
...
exports.noZosmfResponse = {
    message: imperative_1.apiErrorHeader + `No z/OSMF response was received.`
};
/**
 ...
 */
exports.noPingInput = {
    message: imperative_1.apiErrorHeader + `No servlet supplied.`
};
/**
...
exports.noServletKeyInput = {
    message: imperative_1.apiErrorHeader + `No servlet key was supplied.`
};
/**
 ...
 */
exports.noDataInput = {
    message: imperative_1.apiErrorHeader + `No data parameter string was supplied.`
};
/**
...
exports.noCommandInput = {
    message: imperative_1.apiErrorHeader + `No command text was provided.`
};
