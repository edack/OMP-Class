...
class IssueCommand {
    ...
    static issueCommon(session, consoleName, commandParms) {
        ...
        return core_for_zowe_sdk_1.ZosmfRestClient.putExpectJSON(session, IssueCommand.getResource(consoleName), [imperative_1.Headers.APPLICATION_JSON], commandParms);
    }
    /**
