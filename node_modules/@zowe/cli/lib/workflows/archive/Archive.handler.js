    ...
    processCmd(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (sourceType) {
                case "workflowKey":
                    try {
                        resp = yield zos_workflows_for_zowe_sdk_1.ArchiveWorkflow.archiveWorfklowByKey(this.mSession, this.arguments.workflowKey, undefined);
                    }
                    catch (err) {
                ...
                case "workflowName":
                    ...
                    for (const element of getWfKey.workflows) {
                        try {
                            resp = yield zos_workflows_for_zowe_sdk_1.ArchiveWorkflow.archiveWorfklowByKey(this.mSession, element.workflowKey);
