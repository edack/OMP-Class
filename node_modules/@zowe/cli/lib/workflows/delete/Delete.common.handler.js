 ...
 */
class DeleteCommonHandler extends zosmf_for_zowe_sdk_1.ZosmfBaseHandler {
    /**
    ...
    processCmd(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (sourceType) {
                case "workflowKey":
                    try {
                        yield zos_workflows_for_zowe_sdk_1.DeleteWorkflow.deleteWorkflow(this.mSession, this.arguments.workflowKey);
                    }
                    catch (err) {
                ...
                case "workflowName":
                    ...
                    for (const element of getWfKey.workflows) {
                        try {
                            resp = yield zos_workflows_for_zowe_sdk_1.DeleteWorkflow.deleteWorkflow(this.mSession, element.workflowKey);
...
exports.default = DeleteCommonHandler;
//# sourceMappingURL=Delete.common.handler.js.map