    ...
    processCmd(commandParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (util_1.isNullOrUndefined(instances)) {
                ...
                const response = yield provisioning_for_zowe_sdk_1.DeleteInstance.deleteDeprovisionedInstance(this.mSession, provisioning_for_zowe_sdk_1.ProvisioningConstants.ZOSMF_VERSION, id);
