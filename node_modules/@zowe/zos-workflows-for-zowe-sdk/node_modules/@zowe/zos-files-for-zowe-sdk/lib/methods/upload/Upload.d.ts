...
export declare class Upload {
     ...
     * @returns {Promise<object>}
     */
    static bufferToUSSFile(session: AbstractSession, ussname: string, buffer: Buffer, binary?: boolean, localEncoding?: string, etag?: string, returnEtag?: boolean, responseTimeout?: number): Promise<string>;
    /**
     * Upload content to USS file
     * @param {AbstractSession} session - z/OS connection info
     * @param {string} ussname          - Name of the USS file to write to
     ...
     */
    static streamToUssFile(session: AbstractSession, ussname: string, uploadStream: Readable, options?: IUploadOptions): Promise<{
        success: boolean;
     ...
     * @returns {Promise<object>}
     */
    static streamToUSSFile(session: AbstractSession, ussname: string, uploadStream: Readable, binary?: boolean, localEncoding?: string, task?: ITaskWithStatus, etag?: string): Promise<{
        success: boolean;
        commandResponse: string;
        apiResponse: any;
    }>;
     ...
     * @param etag
     */
    static fileToUSSFile(session: AbstractSession, inputFile: string, ussname: string, binary?: boolean, localEncoding?: string, task?: ITaskWithStatus, etag?: string, returnEtag?: boolean): Promise<IZosFilesResponse>;
    /**
