...
class SshSession {
     ...
     */
    static createSshSessCfgFromArgs(args) {
        return {
...
SshSession.SSH_OPTION_HOST_PROFILE = Object.assign(Object.assign({}, SshSession.SSH_OPTION_HOST), { required: false });
/**
...
SshSession.SSH_OPTION_USER_PROFILE = Object.assign(Object.assign({}, SshSession.SSH_OPTION_USER), { required: false });
/**
