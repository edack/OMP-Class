...
exports.ArchiveWorkflow = void 0;
...
class ArchiveWorkflow {
     ...
     */
    static archiveWorfklowByKey(session, workflowKey, zOSMFVersion = WorkflowConstants_1.WorkflowConstants.ZOSMF_VERSION) {
        ...
        query += `/${workflowKey}/${WorkflowConstants_1.WorkflowConstants.ARCHIVE_WORKFLOW}`;
        return core_for_zowe_sdk_1.ZosmfRestClient.postExpectJSON(session, query, [imperative_1.Headers.APPLICATION_JSON], null);
    }
}
exports.ArchiveWorkflow = ArchiveWorkflow;
//# sourceMappingURL=ArchiveWorkflow.js.map