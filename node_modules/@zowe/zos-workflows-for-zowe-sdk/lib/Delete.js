...
class DeleteWorkflow {
     ...
     * @returns {string}
     */
    static deleteWorkflow(session, workflowKey, zOSMFVersion = WorkflowConstants_1.WorkflowConstants.ZOSMF_VERSION) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            resourcesQuery += `${WorkflowConstants_1.WorkflowConstants.WORKFLOW_RESOURCE}/${workflowKey}`;
            return core_for_zowe_sdk_1.ZosmfRestClient.deleteExpectString(session, resourcesQuery, []);
        });
    }
}
