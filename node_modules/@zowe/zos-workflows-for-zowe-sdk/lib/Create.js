...
class CreateWorkflow {
    ...
    // add job statement, account info, comments and resolveGlobalConflictByUsing,
        ...
        return core_for_zowe_sdk_1.ZosmfRestClient.postExpectJSON(session, resourcesQuery, [imperative_1.Headers.APPLICATION_JSON], data);
    }
    /**
    ...
    static uploadTempFile(session, localFile, remoteFile) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield zos_files_for_zowe_sdk_1.Upload.fileToUSSFile(session, localFile, remoteFile, true);
            }
            catch (error) {
    ...
    static deleteTempFile(session, ussFileName) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield zos_files_for_zowe_sdk_1.Delete.ussFile(session, deletableLocation);
            }
            catch (error) {
                return ussFileName;
            }
