...
exports.DefinitionWorkflow = void 0;
...
class DefinitionWorkflow {
     ...
     */
    // main method
    static getWorkflowDefinition(session, zOSMFVersion = WorkflowConstants_1.WorkflowConstants.ZOSMF_VERSION, filePath, steps, variables) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let wfPath;
            WorkflowValidator_1.WorkflowValidator.validateNotEmptyString(filePath, WorkflowConstants_1.noWorkflowDefinitionFile.message);
            wfPath = filePath;
            let resourcesQuery = `${WorkflowConstants_1.WorkflowConstants.RESOURCE}/${zOSMFVersion}/`;
            resourcesQuery += `${WorkflowConstants_1.WorkflowConstants.WORKFLOW_DEFINITION}?${WorkflowConstants_1.WorkflowConstants.filePath}=${wfPath}`;
            if (steps && variables) {
            ...
            return core_for_zowe_sdk_1.ZosmfRestClient.getExpectJSON(session, resourcesQuery, [imperative_1.Headers.APPLICATION_JSON]);
        });
    }
}
exports.DefinitionWorkflow = DefinitionWorkflow;
