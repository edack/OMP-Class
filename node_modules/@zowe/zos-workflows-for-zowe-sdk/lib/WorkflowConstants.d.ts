 ...
 */
export declare class WorkflowConstants {
    /**
     ...
     * @memberof WorkflowConstants
     */
    static readonly WORKFLOW_DEFINITION: string;
    /**
     * URI base for workflows API.
     * @static
     * @type {string}
     * @memberof WorkflowConstants
     */
    static readonly WORKFLOW_RESOURCE: string;
    /**
     * URI base for workflows API.
     * @static
     * @type {string}
     * @memberof WorkflowConstants
     */
    static readonly ARCH_WORKFLOW_RESOURCE: string;
    /**
     ...
     * @memberof WorkflowConstants
     */
    static readonly ARCHIVE_WORKFLOW: string;
    /**
     ...
     * @memberof WorkflowConstants
     */
    static readonly CANCEL_WORKFLOW: string;
    /**
     ...
     * @memberof WorkflowConstants
     */
    static readonly workflowKey: string;
    /**
     * URI base for filter workflows from registry API.
     * @static
     * @type {string}
     * @memberof WorkflowConstants
     */
    static readonly workflowName: string;
    /**
     ...
     * @memberof WorkflowConstants
     */
    static readonly WF_NAME: string;
    /**
     ...
     * @memberof WorkflowConstants
     */
    static readonly returnData: string;
    /**
     ...
     * @memberof WorkflowConstants
     */
    static readonly tempPath: string;
}
/**
 ...
 * @memberof WorkflowConstants
 */
export declare const noWorkflowKey: IMessageDefinition;
/**
 ...
 * @memberof WorkflowConstants
 */
export declare const noSteps: IMessageDefinition;
/**
 ...
 * @memberof WorkflowConstants
 */
export declare const noVariables: IMessageDefinition;
/**
 ...
 * @memberof WorkflowConstants
 */
export declare const noWorkflowDefinitionFile: IMessageDefinition;
/**
 ...
 * @memberof WorkflowConstants
 */
export declare const noWorkflowName: IMessageDefinition;
/**
 ...
 * @memberof WorkflowConstants
 */
export declare const noSystemName: IMessageDefinition;
/**
 * Error message that no system name parameter string was supplied.
 * @static
 * @type {IMessageDefinition}
 * @memberof WorkflowConstants
 */
export declare const wrongString: IMessageDefinition;
/**
