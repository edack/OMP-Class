...
class CliUtils {
     ...
     *      }
     */
    static promptWithTimeout(questionText, hideText = false, secToWait = 30) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (hideText) {
                const os = require("os");
                ttyIo._writeToOutput = function _writeToOutput(stringToWrite) {
            ...
            for (let count = 1; answerToReturn === null && count <= secToWait; count++) {
                yield CliUtils.sleep(oneSecOfMillis);
            }
