...
exports.CliProfileManager = void 0;
    ...
    loadProfile(parms) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!parms.noSecure && security_1.CredentialManagerFactory.initialized) {
                 ...
                 */
                securelyLoadValue = (propertyNamePath, _, optional) => __awaiter(this, void 0, void 0, function* () {
                    let ret;
                    try {
                        ...
                        ret = yield security_1.CredentialManagerFactory.manager.load(profiles_1.ProfileUtils.getProfilePropertyKey(this.profileType, parms.name, propertyNamePath), optional);
                    }
                    catch (err) {
                ...
                securelyStoreValue = (propertyNamePath, propertyValue) => __awaiter(this, void 0, void 0, function* () {
                    try {
                        if (util_1.isNullOrUndefined(propertyValue)) {
                            ...
                            yield security_1.CredentialManagerFactory.manager.delete(profiles_1.ProfileUtils.getProfilePropertyKey(this.profileType, name, propertyNamePath));
                            return undefined;
                        }
