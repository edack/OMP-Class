...
exports.UpdateImpConfig = void 0;
...
class UpdateImpConfig {
     ...
     */
    static addCmdGrp(cmdDefToAdd) {
        const impConfig = utilities_1.ImperativeConfig.instance.loadedConfig;
    ...
    static addProfiles(profiles) {
        ...
        if (impConfig) {
            ...
            for (const profileToAdd of profiles) {
                 ...
                 */
                const existingProfile = impConfig.profiles.find((profileToTest) => {
...
exports.UpdateImpConfig = UpdateImpConfig;
//# sourceMappingURL=UpdateImpConfig.js.map