...
exports.DefinitionTreeResolver = void 0;
...
class DefinitionTreeResolver {
     ...
     */
    static resolve(rootCommandDescription, displayName, callerDir, errorLogger, childrenDefinitions, childrenModuleGlobs, addBaseProfile) {
     ...
     */
    static combineAllCmdDefs(callerDir, cmdDefs = [], cmdModuleGlobs = [], addBaseProfile) {
     ...
     */
    static addBaseProfile(cmdDefs) {
        return cmdDefs.map((cmdDef) => {
