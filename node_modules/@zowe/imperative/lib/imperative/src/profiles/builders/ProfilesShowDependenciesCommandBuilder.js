...
exports.ProfilesShowDependenciesCommandBuilder = void 0;
 ...
 */
class ProfilesShowDependenciesCommandBuilder extends ProfilesCommandBuilder_1.ProfilesCommandBuilder {
    /**
     * Gets the "action" that this command builder is building.
     * @return {string}: The "create" action string
     */
    getAction() {
        return constants_1.Constants.SHOW_DEPS_ACTION;
    }
    /**
    ...
    buildProfileSegmentFromSchema() {
        const profileCommand = {
            ...
            summary: utilities_1.TextUtils.formatMessage(messages_1.showDependenciesCommandDesc.message, { type: this.mProfileType }),
...
exports.ProfilesShowDependenciesCommandBuilder = ProfilesShowDependenciesCommandBuilder;
//# sourceMappingURL=ProfilesShowDependenciesCommandBuilder.js.map