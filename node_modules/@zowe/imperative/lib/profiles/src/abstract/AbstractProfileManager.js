...
exports.AbstractProfileManager = void 0;
                ...
                if (parms.name == null) {
                    ...
                    throw new error_1.ImperativeError({
                        msg: `Your default profile named ${parms.name} does not exist for type ${this.profileType}.\n` +
                            `To change your default profile, run "${utilities_1.ImperativeConfig.instance.rootCommandName} profiles set-default ${this.profileType} ` +
                            `<profileName>".`
                    });
                }
            }
    ...
    delete(parms) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (parms.rejectIfDependency) {
                ...
                const allProfiles = yield this.loadAll({ noSecure: true });
