...
export declare class ZosmfHeaders {
     ...
     * @memberof ZosmfHeaders
     */
    static readonly X_IBM_TEXT_ENCODING: string;
    /**
     * octet stream header
     * @static
     * @memberof ZosmfHeaders
     ...
     * @memberof ZosmfHeaders
     */
    static readonly X_IBM_RESPONSE_TIMEOUT: string;
    /**
     ...
     * @memberof ZosmfHeaders
     */
    static readonly X_IBM_RETURN_ETAG: IHeaderContent;
    /**
     ...
     * @memberof ZosmfHeaders
     */
    static readonly ACCEPT_ENCODING: IHeaderContent;
}
