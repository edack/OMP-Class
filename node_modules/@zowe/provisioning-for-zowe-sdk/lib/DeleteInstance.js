...
class DeleteInstance {
    ...
    static deleteDeprovisionedInstance(session, zOSMFVersion, instanceId) {
        ...
        return core_for_zowe_sdk_1.ZosmfRestClient.deleteExpectString(session, resourcesQuery, [imperative_1.Headers.APPLICATION_JSON]);
    }
}
