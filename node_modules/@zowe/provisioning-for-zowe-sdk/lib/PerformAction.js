...
class PerformAction {
     ...
     */
    static doProvisioningActionCommon(session, zOSMFVersion, instanceId, actionName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            ProvisioningValidator_1.ProvisioningValidator.validateNotEmptyString(actionName, ProvisioningConstants_1.noActionName.message);
            const resourcesQuery = this.getResourcesQuery(zOSMFVersion, instanceId, actionName);
            return core_for_zowe_sdk_1.ZosmfRestClient.postExpectJSON(session, resourcesQuery, [imperative_1.Headers.APPLICATION_JSON]);
        });
    }
    /**
     ...
     * @memberof PerformAction
     */
    static getResourcesQuery(zOSMFVersion, instanceId, actionName) {
        ...
        resourcesQuery += `${ProvisioningConstants_1.ProvisioningConstants.ACTIONS_RESOURCES}/${actionName}`;
