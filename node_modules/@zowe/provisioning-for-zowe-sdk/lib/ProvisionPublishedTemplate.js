...
exports.ProvisionPublishedTemplate = void 0;
...
class ProvisionPublishedTemplate {
    ...
    static provisionTemplateCommon(session, zOSMFVersion, templateName, account) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return core_for_zowe_sdk_1.ZosmfRestClient.postExpectJSON(session, resourcesQuery, [imperative_1.Headers.APPLICATION_JSON], { "account-info": account });
        });
    }
    /**
    ...
    static provisionTemplate(session, zOSMFVersion, templateName, optionalParms) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            resourcesQuery += `${ProvisioningConstants_1.ProvisioningConstants.ACTIONS_RESOURCES}/${ProvisioningConstants_1.ProvisioningConstants.RESOURCE_PROVISION_RUN}`;
            if (optionalParms) {
                return core_for_zowe_sdk_1.ZosmfRestClient.postExpectJSON(session, resourcesQuery, [imperative_1.Headers.APPLICATION_JSON], optionalParms);
            }
            else {
