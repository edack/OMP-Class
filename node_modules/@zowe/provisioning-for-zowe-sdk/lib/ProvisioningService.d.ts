...
export declare class ProvisioningService {
     ...
     */
    static parseProperties(propertiesText: string): IPropertiesInput[];
    /**
     ...
     * @memberof ProvisioningService
     */
    static readPropertiesFromYamlFile(path: string): IPropertiesInput[];
    /**
     ...
     * @memberof ProvisioningService
     */
    static checkForPassedOptionalParms(properties?: string, propertiesFile?: string, domainName?: string, tenantName?: string, userDataId?: string, userData?: string, accountInfo?: string, systemNickNames?: string[]): IProvisionOptionals;
}
