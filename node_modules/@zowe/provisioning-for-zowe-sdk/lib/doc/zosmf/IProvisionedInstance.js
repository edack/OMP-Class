...
exports.explainProvisionedInstanceFull = exports.explainProvisionedInstanceExtended = exports.explainProvisionedInstanceSummaryWithActions = exports.explainProvisionedInstanceSummaryWithVars = exports.explainProvisionedInstanceSummary = void 0;
 ...
 */
exports.explainProvisionedInstanceSummary = Object.assign(Object.assign({}, prettySummary), { ignoredKeys: "variables,actions", explainedParentKey: null });
/**
 * Main explanation map object for provisioned instance summary output with variables.
 * @type IExplanationMap, @see {IExplanationMap}
 * @memberof IProvisionedInstance
 */
exports.explainProvisionedInstanceSummaryWithVars = Object.assign(Object.assign({}, prettySummary), { explainedParentKey: null, variables: IProvisionedInstanceVariable_1.explainProvisionedInstanceVariable, ignoredKeys: "actions" });
/**
 * Main explanation map object for provisioned instance summary output with actions.
 * @type IExplanationMap, @see {IExplanationMap}
 * @memberof IProvisionedInstance
 */
exports.explainProvisionedInstanceSummaryWithActions = Object.assign(Object.assign({}, prettySummary), { explainedParentKey: null, actions: IProvisionedInstanceActions_1.explainProvisionedInstanceActionsSummary, ignoredKeys: "variables" });
/**
 * Main explanation map object for extended provisioned instance output.
 * @type IExplanationMap, @see {IExplanationMap}
 * @memberof IProvisionedInstance
 */
exports.explainProvisionedInstanceExtended = Object.assign(Object.assign({}, prettyFull), { explainedParentKey: null, actions: IProvisionedInstanceActions_1.explainProvisionedInstanceActionsSummary, ignoredKeys: "variables" });
/**
 * Main explanation map object for full provisioned instance output.
 * @type IExplanationMap, @see {IExplanationMap}
 * @memberof IProvisionedInstance
 */
exports.explainProvisionedInstanceFull = Object.assign(Object.assign({}, prettyFull), { explainedParentKey: null, ignoredKeys: null, variables: IProvisionedInstanceVariable_1.explainProvisionedInstanceVariable, actions: IProvisionedInstanceActions_1.explainProvisionedInstanceActionsFull });
