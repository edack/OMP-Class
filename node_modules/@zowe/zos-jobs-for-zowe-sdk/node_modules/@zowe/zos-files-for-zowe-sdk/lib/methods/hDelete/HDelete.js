...
class HDelete {
    ...
    static dataSet(session, dataSetName, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            return ZosFilesUtils_1.ZosFilesUtils.dfsmsHsmCommand(session, dataSetName, ZosFiles_messages_1.ZosFilesMessages.datasetDeletionRequested.message, { request: "hdelete" }, options);
        });
    }
}
exports.HDelete = HDelete;
//# sourceMappingURL=HDelete.js.map