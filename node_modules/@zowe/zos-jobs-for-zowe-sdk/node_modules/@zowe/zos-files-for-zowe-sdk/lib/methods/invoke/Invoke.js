...
class Invoke {
     ...
     */
    static ams(session, controlStatements, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (longStmtIndex >= 0) {
                throw new imperative_1.ImperativeError({
                    msg: util.format(ZosFiles_messages_1.ZosFilesMessages.longAmsStatement.message, longStmtIndex + 1, ZosFiles_constants_1.ZosFilesConstants.MAX_AMS_LINE, core_for_zowe_sdk_1.getErrorContext(statements, longStmtIndex))
                });
            }
            try {
                ...
                const response = yield core_for_zowe_sdk_1.ZosmfRestClient.putExpectJSON(session, endpoint, reqHeaders, reqPayload);
                return {
                    success: true,
