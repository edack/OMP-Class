...
class DownloadJobs {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const file of jobFiles) {
                ...
                yield DownloadJobs.downloadSpoolContentCommon(session, {
                    jobFile: Object.assign(Object.assign({}, file), { ddname: uniqueDDName }),
                    outDir: parms.outDir,
    ...
    static downloadSpoolContentCommon(session, parms) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield core_for_zowe_sdk_1.ZosmfRestClient.getStreamed(session, JobsConstants_1.JobsConstants.RESOURCE + parameters, undefined, writeStream, true);
        });
    }
    /**
