    ...
    static deleteJobCommon(session, parms) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (parms.modifyVersion === "1.0") {
                headers.push(core_for_zowe_sdk_1.ZosmfHeaders.X_IBM_JOB_MODIFY_VERSION_1);
            }
            else if (parms.modifyVersion === "2.0") {
                headers.push(core_for_zowe_sdk_1.ZosmfHeaders.X_IBM_JOB_MODIFY_VERSION_2);
            }
            const parameters = imperative_1.IO.FILE_DELIM + parms.jobname + imperative_1.IO.FILE_DELIM + parms.jobid;
            yield core_for_zowe_sdk_1.ZosmfRestClient.deleteExpectString(session, JobsConstants_1.JobsConstants.RESOURCE + parameters, headers);
        });
    }
    /**
