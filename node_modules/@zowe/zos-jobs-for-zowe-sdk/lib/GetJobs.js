...
class GetJobs {
    ...
    static getJobsCommon(session, parms) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return core_for_zowe_sdk_1.ZosmfRestClient.getExpectJSON(session, resource);
        });
    }
    /**
    ...
    static getStatusCommon(session, parms) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return core_for_zowe_sdk_1.ZosmfRestClient.getExpectJSON(session, JobsConstants_1.JobsConstants.RESOURCE + parameters);
        });
    }
    /**
    ...
    static getJclCommon(session, parms) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return core_for_zowe_sdk_1.ZosmfRestClient.getExpectString(session, JobsConstants_1.JobsConstants.RESOURCE + parameters);
        });
    }
    /**
    ...
    static getSpoolContentById(session, jobname, jobid, spoolId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return core_for_zowe_sdk_1.ZosmfRestClient.getExpectString(session, JobsConstants_1.JobsConstants.RESOURCE + parameters, [imperative_1.Headers.TEXT_PLAIN_UTF8]);
        });
    }
    /**
