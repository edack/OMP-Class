...
export declare class CancelJobs {
     ...
     * @memberof CancelJobs
     */
    static cancelJob(session: AbstractSession, jobname: string, jobid: string, version?: string): Promise<void>;
    /**
     * Cancel and purge a job
     ...
     * @memberof CancelJobs
     */
    static cancelJobForJob(session: AbstractSession, job: IJob, version?: string): Promise<void>;
    /**
     * Cancel and purge a job
     ...
     * @memberof CancelJobs
     */
    static cancelJobCommon(session: AbstractSession, parms: ICancelJobParms): Promise<void>;
    /**
