...
class HRecall {
    ...
    static dataSet(session, dataSetName, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            return ZosFilesUtils_1.ZosFilesUtils.dfsmsHsmCommand(session, dataSetName, ZosFiles_messages_1.ZosFilesMessages.datasetRecallRequested.message, { request: "hrecall" }, options);
        });
    }
}
exports.HRecall = HRecall;
//# sourceMappingURL=HRecall.js.map