    ...
    static allMembers(session, dataSetName, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                let endpoint = path_1.posix.join(ZosFiles_constants_1.ZosFilesConstants.RESOURCE, ZosFiles_constants_1.ZosFilesConstants.RES_DS_FILES, dataSetName, ZosFiles_constants_1.ZosFilesConstants.RES_DS_MEMBERS);
                if (options.pattern) {
                    endpoint += `?pattern=${options.pattern}`;
                }
                let reqHeaders = [];
                if (options.attributes) {
                    reqHeaders = [core_for_zowe_sdk_1.ZosmfHeaders.X_IBM_ATTRIBUTES_BASE];
                }
    ...
    static dataSet(session, dataSetName, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const reqHeaders = [];
                if (options.attributes) {
                    reqHeaders.push(core_for_zowe_sdk_1.ZosmfHeaders.X_IBM_ATTRIBUTES_BASE);
                }
                if (options.maxLength) {
                    reqHeaders.push({ "X-IBM-Max-Items": `${options.maxLength}` });
                }
